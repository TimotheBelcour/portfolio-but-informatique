...
export const projects = [
...

  {
    ...
    title: 'Votendo',
    description:
      "Plateforme web complète de vote de jeux vidéo développée en PHP/MySQL. Inscription, authentification sécurisée, système de rôles et classements dynamiques.",
    image: votendoGallery[0],
    gallery: votendoGallery,
    highlights: [
      "Authentification sécurisée avec sessions PHP et hachage bcrypt des mots de passe",
      "Système de rôles : administrateur, modérateur, utilisateur standard",
      "Vote et classement dynamique des jeux vidéo en temps réel",
      "Sécurité HTTPS (OpenSSL/Apache) et protection contre les injections SQL",
      "Pages dynamiques générées côté serveur en PHP pur sans framework",
    ],
    ...
    objectives: [
      ...
      "Déployer l'application en HTTPS avec Apache et OpenSSL",
    ],
    difficulties: [
      ...
      "Configurer Apache avec SSL/TLS et générer un certificat OpenSSL valide",
    ],
    solutions: [
      ...
      "Configuration d'un Virtual Host Apache avec SSL et redirection HTTP → HTTPS",
    ],
    learned: [
      ...
      "Configuration d'un serveur web Apache avec HTTPS et gestion des certificats",
    ],
    result:
      "Plateforme web fonctionnelle et sécurisée permettant l'inscription, l'authentification, le vote pour des jeux vidéo et la consultation de classements en temps réel. Le système de rôles est pleinement opérationnel, avec HTTPS, protection contre les injections SQL et MCD/MLD documentés.",
  },

  {
    ...
    description:
      "Audit complet d'une application de vote existante : estimation de la taille du projet, analyse des performances, définition des objectifs d'optimisation et monitoring des métriques.",
    image: sae4Gallery[0],
    gallery: sae4Gallery,
    highlights: [
      "Estimation de la taille du projet par métriques (SLOC, points de fonction)",
      "Analyse des goulots d'étranglement et définition d'objectifs d'optimisation",
      "Monitoring des performances applicatives avec métriques en temps réel",
      "Rapport d'audit structuré avec recommandations priorisées",
    ],
    tags: ['Python', 'SQL', 'Linux', 'Audit', 'Performance'],
    ...
    objectives: [
      "Estimer la taille et la complexité de l'application par méthodes formelles",
      "Identifier les goulots d'étranglement applicatifs et les requêtes SQL lentes",
      "Définir des objectifs d'optimisation mesurables et priorisés",
      "Monitorer les performances avant/après pour valider les améliorations",
      "Produire un rapport d'audit professionnel avec recommandations",
    ],
    difficulties: [
      "Analyser un codebase existant sans documentation ni connaissance préalable",
      "Choisir des métriques pertinentes pour l'estimation de taille du projet",
      "Identifier les requêtes SQL problématiques dans un environnement de production",
      "Coordonner le travail d'audit en équipe avec des périmètres distincts",
    ],
    solutions: [
      "Comptage SLOC et identification des points de fonction pour l'estimation",
      "Profiling des requêtes SQL avec EXPLAIN ANALYZE pour détecter les N+1",
      "Mise en place d'un tableau de bord de monitoring des temps de réponse",
      "Répartition par domaine (base de données, back-end, front-end) entre les membres",
    ],
    learned: [
      "Méthodes formelles d'estimation de projet logiciel (COCOMO, points de fonction)",
      "Techniques de profiling SQL et identification des requêtes non optimisées",
      "Approche structurée de l'audit technique : analyse, priorisation, recommandation",
      "Communication des résultats d'audit à différents niveaux de technicité",
    ],
    result:
      "Rapport d'audit complet documentant la taille de l'application (SLOC, points de fonction), les 5 goulots d'étranglement identifiés et un plan d'optimisation priorisé. Le tableau de bord de monitoring permet de mesurer l'impact de chaque amélioration après implémentation.",
  },

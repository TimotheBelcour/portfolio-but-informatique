...
const colorMap = {
  violet: { accent: 'text-violet-400', bg: 'bg-violet-500/5',  border: 'border-violet-500/20', dot: 'bg-violet-400', bar: 'bg-violet-500' },
  blue:   { accent: 'text-blue-400',   bg: 'bg-blue-500/5',    border: 'border-blue-500/20',   dot: 'bg-blue-400',   bar: 'bg-blue-500'   },
  green:  { accent: 'text-green-400',  bg: 'bg-green-500/5',   border: 'border-green-500/20',  dot: 'bg-green-400',  bar: 'bg-green-500'  },
  orange: { accent: 'text-orange-400', bg: 'bg-orange-500/5',  border: 'border-orange-500/20', dot: 'bg-orange-400', bar: 'bg-orange-500' },
  yellow: { accent: 'text-yellow-400', bg: 'bg-yellow-500/5',  border: 'border-yellow-500/20', dot: 'bg-yellow-400', bar: 'bg-yellow-500' },
  pink:   { accent: 'text-pink-400',   bg: 'bg-pink-500/5',    border: 'border-pink-500/20',   dot: 'bg-pink-400',   bar: 'bg-pink-500'   },
}
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-16 space-y-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        {/* Sidebar */}
        <Reveal as="aside" className="space-y-6" delay={120}>
          ...
          {relatedProjects.length > 0 && (
            <div className="space-y-3">
              ...
              {relatedProjects.map((project) => (
                <div
                  key={project.id}
                  className="p-4 bg-slate-900 border border-slate-800 rounded-xl space-y-2 hover:border-slate-700 hover:-translate-y-0.5 transition-all duration-200"
                >

        ...
        >
          ...
          <div className="relative px-6 pt-8 pb-6 flex flex-col items-center text-center space-y-4">
            ...
            <div className="relative">
              ...
              <div
                ...
                style={{
                  background:
                    'conic-gradient(from 180deg, rgba(139,92,246,0.5), rgba(96,165,250,0.4), rgba(139,92,246,0.5))',
                  filter: 'blur(8px)',
                  opacity: 0.6,
                }}
              />
              {/* Anneau gradient visible */}
          ...
          <div className="px-5 py-4 flex items-center justify-center gap-2">
            <a
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs text-slate-400 hover:text-slate-100 bg-slate-800/60 hover:bg-slate-800 border border-slate-700/50 hover:border-slate-600 transition-all duration-200"
            >
